    ...
    return {
      coax: {
        ...
        insulator: {
          ...
          functionality: "Maintains uniform spacing between conductors to preserve constant impedance (50 Ω or 75 Ω).",
        },
        "inner-conductor": {
          id: "inner-conductor",
      ...
      fiber: {
        ...
        cladding: {
          id: "cladding",
          name: "Glass Cladding (n₂)",
          overview: "Outer glass cladding layer with lower refractive index (n₂ < n₁).",
        ...
        core: {
          id: "core",
          name: "Glass Core (n₁)",
          overview: "Ultra-pure central silica glass core carrying high-speed optical pulses (n₁).",
          material: "Ultra-pure fused silica glass (SiO₂).",
